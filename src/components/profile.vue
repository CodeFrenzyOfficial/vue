  ...
  <b-card class="text-center overflow-hidden"  no-body   h-100 style="max-width: 1240px;" title-variant="card_title">
   ...
   <!--  <b-row no-gutters style="max-height: 550px;">
      ...
      <b-col md="3"  class="p-0 profile-card-text" >
        <b-card-img :src= "memberImage"  alt="Image" class="rounded-0"  height="125" fluid-grow @error="imageLoadError"></b-card-img>
      ...
      <b-col md="8"  class="profile-card-text ">
        ...
        <b-button v-if="showEdit" id="show-btn"  @click="OnEditClicked('Title')" >Edit Title</b-button>
          ...
          <li class = "pb-2 pt-0" v-for="(item, index) in selectedSpecialities" :key="index" >
            {{ item.INTEREST }}
          </li>
          <b-button v-if="showEdit" id="show-btn"  @click="OnEditClicked('Specialities')" >Edit Specialities</b-button>

          
          <p class ="mt-3 mb-0"> Program: </p> 
      ...
      <section class="bio__about__biography">
        ...
        /> -->
        <b-button v-if="showEdit" id="show-btn"  @click="OnEditClicked('Research_Interest')" >Edit Research Interest</b-button>
    ...
    <b-tabs class="h4"  card v-model="NIH_Pubs_step">
      ...
      <b-tab title="Selected Funding" @click = "tabChange('OtherFunding')"  >
 ...
 //import RESEARCHERSDATA from "../data/Researchers.json";
  // import RESEARCHERSDATA from "../data/ResearchsData.json";
   ...
   // alert(self.allResearchers.ALLRESEARCHERSDATA[5].FIRST_NAME)
    ...
    axios
      .get("https://adminapi20220513111902.azurewebsites.net/api/Researchers_Web_Profiles/" + arg)
