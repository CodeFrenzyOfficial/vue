<template>
   ...
   <!--  <b-row no-gutters style="max-height: 550px;">
      ...
      <b-col md="8"  class="profile-card-text ">
        ...
        <!-- <b-button  id="show-btn"  @click="OnEditClicked('Pubs')" >Refresh Pubs</b-button> -->
          ...
          <p class ="mt-3 mb-0" v-if = "typeof this.CANCER_FOCUS !== 'undefined' && this.CANCER_FOCUS.length > 0">Member Cancer Focus  xxxx</p> 
  ...
  <div class="d-flex align-items-center">
      ...
      <section class="bio__about__biography">
        <!-- <h3 class="h3 section-title">Main Researchers Page</h3> -->
        <b-row  no-gutters > 
  <b-col cols="1" class="p-0 profile-card-text" ></b-col>
  <b-col cols="3" class="p-0 profile-card-text" ></b-col>
  <b-col cols="8" class="p-0 profile-card-text" >
<b-button class="btn btn-primary"  @click="showDetailModal('close')" >FIND A  RESEARCHER</b-button> 
</b-col>
</b-row>
...
//   alert("child")
  ...
  await  axios
      .get("https://adminapi20220513111902.azurewebsites.net/api/Researchers_Web_Profiles/" + arg.trim() + "/email" )
    ...
    if (urlParams.size === 0) {  
      ...
      if (urlParams.has('MemberID') === true ){
       ...
       //   this.loadSelectedMember(this.researcherID, "MemberID") 
          this.loadSelectedResearcher(urlParams.get('MemberID'))
          this.step = 4 
          this.showSpinner = false 
