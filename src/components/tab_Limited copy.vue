  ...
  //runQuery
    ...
    //   this.searchLogic = "MemberID_Search"
     ...
     //  this.search_last_name = ""
       this.search_last_name_hidden = "Rockey"
       this.MemberID = urlParams.get('MemberID')

      // this.RESEARCHERSLIST = researcher_Data.RESEARCHERSLIST.filter(item => item.MEMBERID === this.MemberID );
