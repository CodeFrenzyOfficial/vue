   ...
   <!--  <b-row no-gutters style="max-height: 550px;">
      ...
      <b-col md="8"  class="profile-card-text ">
        ...
        <b-card-body class="ml-5 mt-2 text-left title-highligh" v-bind:title= "membername">
          <b-button  v-if="showEdit" id="show-btn"  @click="OnEditClicked('Name')" >Edit Name</b-button>
        ...
        <b-button v-if="showEdit" id="show-btn"  @click="OnEditClicked('Title')" >Edit Title</b-button>
          <hr class="hr-highligh mt-3" />
      ...
      <section class="bio__about__biography">
        <h3 class="h4 profile_sub_section-title">Biography:</h3>
        ...
        /> -->
        <b-button v-if="showEdit" id="show-btn"  @click="OnEditClicked('Biography')" >Edit Biography</b-button>
      ...
      <!-- Positions section -->
      <section v-if = "selectedPositions.length != showEdit" class="bio__credentials__positions">
        ...
        <b-card
          ...
          align="left"
          header-html="<span class='h5 profile_section_sub-title'> Hollings Cancer Center </span>"
        >
          <b-card-text>
      ...
      <section  v-if = "selectedEducationTraining.length != showEdit"  class="bio__credentials__background">
    ...
    <section v-if = "selectedFellowship.length != showEdit" >
        ...
        <!-- Professional memberships subsection -->
         <section v-if = "selectedMemberships.length != showEdit">
    ...
    <!-- <section v-if = "selectedLabMembers.length != showEdit">
        <strong>Lab members:</strong><br />
        <b-button v-if="showEdit" id="show-btn"  @click="OnEditClicked('LabMembers')" >Edit Lab Members</b-button>
        <div class="card-body">
          <div v-for="(item, index) in selectedLabMembers" :key="index">
            {{ item.ITEM }} {{ item.DATA }}
          </div>
        </div>
      </section> -->
    ...
    <b-tabs class="h4"  card v-model="NIH_Pubs_step">
        <b-tab title="Selected NIH Funding" @click = "tabChange('Funding')"  >
...
<b-tab title="Selected Publications" @click = "tabChange('Publications')"  >
       ...
       <!-- <section class="bio__about__biography">
        <h3 class="h3 profile_section-title">Biography:</h3>-->
        <!-- Edit button for biography section -->
        <!-- <input
          class="edit-btn"
          type="button"
      ...
      <section class="article__content--research" id="research"  v-if = "selectedResearchOverView.length != showEdit">
        ...
        <h4 class="h4 profile_sub_section-title">Selected Publications:</h4>
  ...
  // import RESEARCHERSDATA from "../data/ResearchsData.json";
   ...
   //import * as _altmetric_embed_init from 'https://d1bxh8uas1mnw7.cloudfront.net/assets/embed.js';
    ...
    //      }
       ...
       this.pubLink = this.researcher.PUBLICATION_LINK
  ...
  return "N/A"
    ...
    detailEditItem( item) {
      ...
      let arg = this.mode
        ...
        this.newYear = this.researcher.BIOGRAPHY[index].ITEM
        this.newData = this.researcher.BIOGRAPHY[index].DATA
        ...
        this.centeredTitle ="Edit Research OverView item";
  
        this.newYear = this.researcher.RESEARCH_OVERVIEW[index].ITEM
        this.newData =  this.researcher.RESEARCH_OVERVIEW[index].DATA
         this.mode = "ResearchOverView"
          break;
       ...
       // this.tempItem = JSON.parse(JSON.stringify(this.HonorsAwards));
        ...
        this.newData =  this.researcher.HONORSAWARDS[index].DATA     
         ...
         case 'LabMembers':
        this.centeredTitle ="Edit Lab Members";
       // this.tempItem = JSON.parse(JSON.stringify(this.HonorsAwards));
        this.mode = "LabMembers"

        this.newYear = this.researcher.LABMEMBERS[index].ITEM
        this.newData =  this.researcher.LABMEMBERS[index].DATA     
    ...
    OnEditClicked(arg) {
      ...
      //  this.styleObject["max-height"] = '350px' 
        ...
        this.tempItem = JSON.parse(JSON.stringify(this.researcher.BIOGRAPHY));
        this.mode = "Biography"
        ...
        break;
        case 'ResearchOverView':
        this.centeredTitle ="Edit Research OverView";
        this.tempItem = JSON.parse(JSON.stringify(this.researcher.RESEARCH_OVERVIEW));
        this.mode = "ResearchOverView"
        this.placeholderData="Research OverView Data"
        this.modeLabel ="Research OverView"
        this.dataTableColumn2 = "Research OverView Data"
        this.dataTableColumn1 = "Item"
        break;
        ...
        case 'LabMembers':
        this.centeredTitle ="Edit Lab Members";
        this.tempItem = JSON.parse(JSON.stringify(this.researcher.LABMEMBERS));
        this.mode = "LabMembers"
        this.placeholderData="Lab Member"
        this.modeLabel ="Lab Member"
        this.dataTableColumn2 = "Lab Member"
        this.dataTableColumn1 = "Item"
  ...
  img.onload = function() {
   ...
   img.src = 'https://muschealth.org/-/sm/news-center-media/news-center-images/2017-images/10/dubois.ashx?h=666&w=1000&la=en&hash=EA10C2D6CF3E784279121BFCF213CF7C' //'https://hcc.admin.musc.edu/rockey.jpg';
      ...
      computed: {
        ...
        selectedBiography(){
          return this.researcher.BIOGRAPHY.filter(item => item.ISSELECTED);
        },
  
        selectedPositions() {
        console.log(this.researcher.POSITIONS.filter(item => item.ISSELECTED))
        ...
        selectedLabMembers(){
            return this.researcher.LABMEMBERS.filter(item => item.ISSELECTED);
        }
